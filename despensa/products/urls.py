...
urlpatterns = [
    ...
    path('use_product/<id>', views.use_product, name='use_product'), # todo no front
    path('shop_product/<id>', views.shop_product, name='shop_product'), # todo no front
    path('shopping_list', views.shopping_list, name='shopping_list'), # todo no front
